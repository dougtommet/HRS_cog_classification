...
hcap <- hcap %>%
  mutate(dx = case_when(cog_threshold==2 & iadl_threshold==1 ~ 2,
                        ...
                        cog_threshold==0 ~ 0,
                        vs3jormsc_iflag==0 & vs3jormsc >= 3.4 ~ 2,
                        vs3jormsc_iflag==0 & vs3jormsc > 3.0 &  vs3jormsc < 3.4 ~ 1,
                        vs3jormsc_iflag==0 & vs3jormsc <= 3.0  ~ 0
  ))
QSPtools::checkvar(hcap, dx, cog_threshold, iadl_threshold, self_concerns)
