<!-- MS_Tab_Fig_Apndx-060-Table-3.3.qmd -->
<!-- Rich Jones --> 
<!-- 2025-07-22 -->
...
### Table 3.3 Diagnostic Comparison: HRS/Core Actuarial Classification versus HRS Langa-Weir Classification (N=2,992)
Cell entries are observed percentages of the total HRS/HCAP subsample.

```{r}
cell11 <- 108 # Dementia, Dementia
cell12 <- 115 # Dementia, MCI
cell13 <-  45 # Dementia, Normal
cell21 <-  64 # MCI, Dementia
cell22 <- 224 # MCI, MCI 
cell23 <- 216 # MCI, Normal
cell31 <-  35 # Normal, Dementia
cell32 <-  275 # Normal, MCI 
cell33 <- 1910 # Normal, Normal 
...
The weighted kappa statistic is `r round(kappa_w, 2)`, indicating a "fair" level of agreement between the HRS/Core actuarial classification and the HRS Langa-Weir Classification.
...
The agreement (unweighted Cohen's kappa) for dementia vs MCI or Normal is `r foo` indicating a "fair" level of agreement between the HRS/Core actuarial classification and the Langa-Weir classification.
