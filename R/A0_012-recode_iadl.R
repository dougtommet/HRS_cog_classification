...
hrs16_iadl <- hrs16_iadl %>%
  mutate(rPG014 = case_when(PG014==1 ~ 1,
         ...
         rPG021 = case_when(PG021==1 ~ 1,
                            ...
                            PG021==8 ~ NA,
                            PG021==9 ~ 1,
                            is.na(PG021) & PG013==0 ~ 0,
                            PG014==5 & (is.na(PG021) | PG021==7|PG021==8) ~ 0),
         rPG023 = case_when(PG023==1 ~ 1,
                            ...
                            PG023==8 ~ NA,
                            PG023==9 ~ 1,
                            is.na(PG023) & PG013==0 ~ 0,
                            PG014==5 & (is.na(PG023) | PG023==7|PG023==8) ~ 0),
         rPG030 = case_when(PG030==1 ~ 1,
                            ...
                            PG030==8 ~ NA,
                            PG030==9 ~ 1,
                            is.na(PG030) & PG013==0 ~ 0,
                            PG014==5 & (is.na(PG030) | PG030==7|PG030==8) ~ 0),
