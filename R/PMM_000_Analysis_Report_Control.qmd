...
source(here::here("R", "PMM_031_Pull_data.R"))
source(here::here("R", "PMM_033_Sample_identification.R"))
source(here::here("R", "PMM_041_Data_cleaning_functional_items.R"))
source(here::here("R", "PMM_042_Data_cleaning_consensusdx_sampling_weight.R"))
source(here::here("R", "PMM_045_Data_generation_tables_analyses.R"))

source(here::here("R", "PMM_100_norming_npb.R"))
source(here::here("R", "PMM_101_mplus_function.R"))
source(here::here("R", "PMM_102_calibration_model.R"))
source(here::here("R", "PMM_103_calibration_model.R"))
...
kappa_gt <- function(k) {
  ...
  slice(2) %>%
  gt::gt() %>%
  gt::tab_header("Cohen's weighted Kappa") %>%
...
{{< include PMM_031_Pull_data.qmd >}}
{{< include PMM_037_Descriptives_in_analysis_Sample.qmd >}}
{{< include PMM_040_Data_cleaning_functional_items.qmd >}}
{{< include PMM_047_Summary_data_prep.qmd >}}

{{< include PMM_100_pmm_text.qmd >}}

{{< include PMM_103_calibration_model.qmd >}}
<!--{{< include PMM_102_calibration_model.qmd >}}-->
{{< include PMM_110_Comparison_of_Consensus_Langa_Weir.qmd >}}
{{< include PMM_112_Margins.qmd >}}

{{< include PMM_888_References.qmd >}}
